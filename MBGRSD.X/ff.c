...
FRESULT chk_lock (	/* Check if the file can be accessed */
	DIRC* dp,		/* Directory object pointing the file to be checked */
...
UINT inc_lock (	/* Increment object open counter and returns its index (0:Internal error) */
	DIRC* dp,	/* Directory object pointing the file to register or increment */
...
FRESULT dir_sdi (	/* FR_OK(0):succeeded, !=0:error */
	DIRC* dp,		/* Pointer to directory object */
...
FRESULT dir_next (	/* FR_OK(0):succeeded, FR_NO_FILE:End of table, FR_DENIED:Could not stretch */
	DIRC* dp,		/* Pointer to the directory object */
...
FRESULT dir_find (	/* FR_OK(0):succeeded, !=0:error */
	DIRC* dp			/* Pointer to the directory object linked to the file name */
)
{
	FRESULT res;
	BYTE c, *dir;
...
FRESULT dir_register (	/* FR_OK:succeeded, FR_DENIED:no free entry or too many SFN collision, FR_DISK_ERR:disk error */
	DIRC* dp				/* Target directory with object name to be created */
)
{
	FRESULT res;
#if _USE_LFN	/* LFN configuration */
...
FRESULT dir_remove (	/* FR_OK:Succeeded, FR_DISK_ERR:A disk error */
	DIRC* dp				/* Directory object pointing the entry to be removed */
)
{
	FRESULT res;
#if _USE_LFN	/* LFN configuration */
...
FRESULT follow_path (	/* FR_OK(0): successful, !=0: error code */
	DIRC* dp,			/* Directory object to return last directory and found object */
...
FRESULT f_opendir (
	DIRC* dp,			/* Pointer to directory object to create */
	const TCHAR* path	/* Pointer to the directory path */
)
{
	FRESULT res;
...
FRESULT f_closedir (
	DIRC *dp		/* Pointer to the directory object to be closed */
)
{
	FRESULT res;
...
FRESULT f_readdir (
	DIRC* dp,			/* Pointer to the open directory object */
...
FRESULT f_findfirst (
	DIRC* dp,				/* Pointer to the blank directory object */
	FILINFO* fno,			/* Pointer to the file information structure */
